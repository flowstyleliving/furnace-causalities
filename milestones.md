...
The post was up for a fair while before the subreddit's moderators removed it. Taken together with the earlier LessWrong ban, the venue question the paragraph above raised — where work like this actually gets a hearing — is now sharper rather than settled. The removal changes nothing about the results, which remain public and reproducible; it changes only where the conversation about them can happen.
