...
A detector this project has used for months reads attention geometry through seven separate measurements, each taken at three fixed depths in the network. Capturing all seven at every layer for the first time showed that two of them separate correct answers from hallucinated ones no better than a coin flip — at any depth, on any of seventeen model-and-task pairs — and the fitting procedure never selected either across eighty-five independent rounds. They had gone unnoticed because the seven are always averaged together, and five working measurements are enough to make the blend look healthy. An earlier pass over only three of the seven had suggested the panel splits into two distinct kinds of signal; the full set showed that split was an artifact of which three were sampled, and that the strongest single measurement was one nobody had examined. The detector's accuracy is unchanged by either finding. What changes is the accounting: the panel carries less variety, and had received less scrutiny, than its size implied.
